                ...
                <div class="content">
                    ...
                    <form action="" method="post" id="form">
                        <div class='btn-navigation'> 
                            <div class='pull-right'>
                                <a class="btn btn-primary" href="<?php echo site_url();?>sitenav/pengguna/tambah"><i class="fa fa-plus-circle"></i> Tambah Pengguna</a>
                            </div>  
                            <div class='pull-right'>
                                <a class="btn btn-primary" href="<?php echo site_url();?>sitenav/pengguna"><i class="fa fa-times-circle"></i> Bersihkan Pencarian</a>
                            </div>
                        </div>
                        <div class='row'>
                    ...
                    <div class="table-responsive">
                        <table class="hover">
                            ...
                            <tbody>
	                            ...
	                            $like_admin[$cari]			= $q;
	                        if ($jml_data > 0){
	                            foreach ($this->ADM->grid_all_admin2('', 'admin_level_nama', 'ASC', $batas, $page, '', $like_admin) as $row){
	                            ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <div class="btn-group">
								            ...
								            <ul class="dropdown-menu pull-right" role="menu">
									            <li>
                                                    <a href="<?php echo site_url();?>sitenav/pengguna/edit/<?php echo $row->admin_user; ?>" title="Edit"><i class='fa fa-pencil'></i> Edit</a>
                                                </li>
									            <li>
                                                    <a href="<?php echo site_url();?>sitenav/pengguna_detail/<?php echo $row->admin_user;?>" rel="detail" title="Detail <?php echo $row->admin_nama; ?>"><i class='fa fa-eye'></i> Detail</a>
                                                </li>
									            <li>
                                                    <a href="javascript:;" data-id="<?php echo $row->admin_user;?>" data-toggle="modal" data-target="#modal-konfirmasi" title="Hapus <?php echo $row->admin_nama; ?>"><i class='fa fa-trash-o'></i> Hapus</a>
                                                </li>
								            </ul>
								        </div>	
                    ...
                    <div id='pagination'>
                        ...
                        <div class='pagination-right'>
                            <ul class="pagination">
                                <?php if ($jml_halaman > 1) { echo pages($halaman, $jml_halaman, 'sitenav/pengguna/view', $id=""); }?>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="page-head">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>admin"><i class='fa fa-home'></i> Dashboard</a></li>
        <li><a href="<?php echo base_url();?>sitenav/menu"><?php echo $breadcrumb; ?></a></li>
...
<div class="cl-mcont">
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form role="form" class="form-horizontal" action="<?php echo site_url();?>sitenav/pengguna/tambah" method="post" enctype="multipart/form-data" parsley-validate novalidate>
                        <div class="table-responsive">
                            <table class="table no-border hover">
                                ...
                                <tbody class="no-border-y"> 
                                    <tr>
                                        ...
                                        <td>
                                            <input name="admin_user" type="text" required class="form-control input-sm"  id="admin_user" value="<?php echo $admin_user; ?>" placeholder="Masukan Username"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="130">
                                            <label for="admin_pass" class="control-label" >Password <span class="required">*</span></label>
                                        </td>
                                        <td>
                                            <input name="admin_pass" type="password" required class="form-control input-sm" id="admin_pass" value="<?php echo $admin_pass; ?>" placeholder="Masukan Password"/>
                                        </td>
                                    </tr>
                                    <!-- 
                                    <tr>
                                        <td width="130">
                                            <label for="admin_pass_ulang" class="control-label">Ulangi Kata Kunci <span class="required">*</span></label>
                                        </td>
                                        <td>
                                            <input name="admin_pass_ulang" type="password" required class="form-control input-sm" id="admin_pass_ulang" value="" size="30" maxlength="50"/>
                                        </td>
                                    </tr>
                                    -->	
                                    <tr>
                                        ...
                                        <td>
                                            <input name="admin_nama" type="text" id="admin_nama" required class="form-control input-sm"  value="<?php echo $admin_nama; ?>" size="30" maxlength="30" placeholder="Masukan Nama Lengkap"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="130">
                                        ...
                                        <td>
                                            <input name="admin_alamat" type="text" id="admin_alamat" required class="form-control input-sm"  value="<?php echo $admin_alamat; ?>" size="50" maxlength="255" placeholder="Masukan Alamat"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="130">
                                        ...
                                        <td>
                                            <input name="admin_telepon" type="text" required class="form-control input-sm"  id="admin_telepon" value="<?php echo $admin_telepon; ?>" size="15" maxlength="15" placeholder="Masukan No.Telepon"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                        ...
                        <div class='center'>
                            ...
                            <input class="btn btn-default" type="reset" name="batal" value="Batalkan" onclick="location.href='<?php echo site_url(); ?>sitenav/pengguna'"/>
                        </div>
                    </form>
                </div>
            </div>
...
<div class="page-head">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>admin"><i class='fa fa-home'></i> Dashboard</a></li>
        <li><a href="<?php echo base_url();?>sitenav/pengguna"><?php echo $breadcrumb; ?></a></li>
...
<div class="cl-mcont">
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form role="form" class="form-horizontal" action="<?php echo site_url();?>sitenav/pengguna/edit" method="post" enctype="multipart/form-data" parsley-validate novalidate>
                        <input type="hidden" name="admin_user" value="<?php echo $admin_user;?>" />
                        <div class="table-responsive">
                            <table class="table no-border hover">
                                <tbody class="no-border-y">
                                    ...
                                    <tr>
                                        <td width="130">
                                            <label for="admin_pass_ulang" class="required">Ulangi Kata Kunci <span class="required">*</span></label>
                                        </td>
