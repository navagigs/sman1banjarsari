...
<!-- Breadcrumb -->
<div class="page-head">
    <h3>Kategori <small>Berita</small></h3>
    <ol class="breadcrumb">
                                    ...
                                    <td align="center">
                                        ...
                                        <div class="btn-group">
								            ...
								            <ul class="dropdown-menu pull-right" role="menu">
									            ...
									            <li>
                                                    <a data-toggle="modal" data-target="#mod-info" type="button"  href="<?php echo site_url();?>website/kategori_detail/<?php echo $row->kategori_id;?>" rel="detail" title="Detail <?php echo $row->kategori_judul; ?>"><i class='fa fa-eye'></i> Detail</a>
                                                </li>
									            <li>
                                                    <a href="javascript:;" data-id="<?php echo $row->kategori_id;?>" data-toggle="modal" data-target="#modal-konfirmasi" title="Hapus <?php echo $row->kategori_judul; ?>"><i class='fa fa-trash-o'></i> Hapus</a>
                                                </li>
								            </ul>
								        </div>	
...
<div class="page-head">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>admin"><i class='fa fa-home'></i> Dashboard</a></li>
        <li><a href="<?php echo base_url();?>website/kategori"><?php echo $breadcrumb; ?></a></li>
...
<div class="cl-mcont">
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form role="form" class="form-horizontal" action="<?php echo site_url();?>website/kategori/tambah" method="post" enctype="multipart/form-data" parsley-validate novalidate>
                        <div class="table-responsive">
                            <table class="table no-border hover">
                                <tbody class="no-border-y">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" required class="form-control input-sm" placeholder="Masukan Nama Kategori" size="100" name="kategori_judul" id="kategori_judul" value="<?php echo $kategori_judul; ?>">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
<div class="cl-mcont">
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form role="form" class="form-horizontal" action="<?php echo site_url();?>website/kategori/edit/<?php echo $kategori_id; ?>" method="post" enctype="multipart/form-data" parsley-validate novalidate>
                            ...
                            <table class="table no-border hover">
                                <tbody class="no-border-y">
    	                           <tr>
                                       ...
                                       <td>
                                           <input type="text" name="kategori_judul" required class="form-control input-sm" id="kategori_judul" value="<?php echo $kategori_judul; ?>" placeholder='Masukan Nama Kategori' size="40" maxlength="40" />
                                       </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <div class="table-responsive">
        <table width="100%" border="0" align="center" id="form_detail">
    	    ...
    	    <tr class="awal">
                ...
                <td>: <?php echo $kategori->kategori_warna; ?></td>
             </tr>
        </table>
    </div>
</div>
