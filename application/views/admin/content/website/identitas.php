            ...
            <div class="block-flat">
                <div class="content">
                        <?php if ($this->session->flashdata('success') || $this->session->flashdata('error')) { ?>
                            ...
                            <?php } ?>
                        <?php } ?>
                        <form  role="form" class="form-horizontal" action="<?php echo site_url();?>website/identitas/edit/<?php echo $identitas_id;?>" method="post" enctype="multipart/form-data" parsley-validate novalidate>
