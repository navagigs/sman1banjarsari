...
<style type="text/css">
    body {
    background:url(<?php echo base_url();?>templates/admin/images/bg.jpg);
    }
</style>	
</head>
...
<div id="cl-wrapper" class="error-container">
	<div class="page-error">
		...
		<h2 class="description text-center">Page not found. </h2>
		<h3 class="text-center">Would you like to go <a href="<?php echo base_url();?>home">home</a>?</h3>
	</div>
	<div class="text-center copy"><?php echo date('Y');?> © <?php echo $web->identitas_website;?>, <br> All rights reserved. Design and Development by <a href="http://nava.web.id" target="_blank">Kania</a></div>
